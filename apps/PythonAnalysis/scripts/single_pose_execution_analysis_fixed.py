#!/usr/bin/env python3
"""
SinglePose Execution Time Analysis - Updated for PythonAnalysis App

Creates execution time and computation time boxplots for SinglePose evaluation data.
"""
...
def create_execution_time_boxplots(data, output_path):
    ...
    if bp2_success['boxes'] and bp2_failed['boxes']:
...
def main():
    ...
    output_dir = results_dir / "single_pose_execution_analysis"
